...
RCT_EXPORT_METHOD(_init:(NSDictionary *)indic){
  ...
  NSString *pickerLeftText=[NSString stringWithFormat:@"%@",indic[@"pickerLeftText"]];
  NSString *pickerRightText=[NSString stringWithFormat:@"%@",indic[@"pickerRightText"]];
  BOOL multiSelection=[indic[@"multiSelection"] boolValue];
